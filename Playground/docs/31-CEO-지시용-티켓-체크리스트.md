...
| P0-ENG-005 | **엔지니어** | — | :3110 500 수정 → integrations/health 200 | curl 3110 | ☐ |
...
| P2-ENG-002 | **엔지니어** | 전원 | yaml 10종 registry·validator | 10/10 | ☐ |
...
```text
[대표 본인] P0-REP-001~004 오늘 30분 내 결정

[엔지니어 ○○○]
  P0-ENG-001~003, P1-ENG-001 (P0-REP-004 승인 후)

[재무 △△△]
  P0-FIN-001

[운영PM □□□]
  P1-PM-001 (엔지니어 착수 전 브리핑 항목 확정)
```
